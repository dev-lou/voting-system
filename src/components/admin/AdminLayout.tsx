...
export function AdminLayout({
  ...
  return (
    <div className="flex h-screen w-screen flex-col overflow-hidden bg-zinc-50 dark:bg-zinc-950">
      ...
      {/* Title Bar */}
      <div className="flex h-9 shrink-0 items-center justify-between bg-zinc-900 text-zinc-300 px-4 text-xs">
        ...
        <div className="flex items-center gap-3">
          <ThemeToggle />
          <span className="text-zinc-400">{adminEmail}</span>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-56 bg-zinc-900 flex flex-col border-r border-zinc-800">
            ...
            {NAV_ITEMS.map(({ section, label, icon }) => {
              ...
              return (
                <button
                  ...
                  className={`
                    w-full flex items-center gap-3 px-5 py-3 text-left text-sm font-medium transition-all
                    ${isActive
                      ? 'bg-maroon-700 text-white border-r-4 border-maroon-500'
                      : 'text-zinc-400 hover:bg-zinc-800 border-r-4 border-transparent'
                    }
                  `}
                >
          ...
          <div className="p-3 border-t border-zinc-800">
            <button
              onClick={onLogout}
              className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-zinc-400 hover:text-red-400 hover:bg-zinc-800 rounded-lg transition-colors"
            >
